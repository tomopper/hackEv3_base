...
int Bingo::get(){
    ...
    for(int i=1; i<6; i=i+2)
    {
        ...
        {
            if(blockstorage[i][j].getBlock() != null)
            {
    ...
    blockstorage[6][4].setRunningBody(null);
    System.out.println("自己位置:(" + rb.getX() + "," + rb.getY() + ") 向き:" + rb.getDirection());
    rb.setBlock(block[6]);
    if(rb.getBlock() != null)
    ...
    blockstorage[4][4].setRunningBody(null);
    System.out.println("運搬後");
    System.out.println("自己位置:(" + rb.getX() + "," + rb.getY() + ") 向き:" + rb.getDirection());
    rb.setBlock(null);
    if(rb.getBlock() == null)
        System.out.println("ブロックを持っていない");
    blockstorage[4][4].setBlock(null); //???X?u???????u???b?N???????i?{????????????j
    ...
    blockstorage[p[0]][p[1]].setRunningBody(null);
    System.out.println("自己位置:(" + rb.getX() + "," + rb.getY() + ") 向き:" + rb.getDirection());
    rb.setBlock(block[2]);
    if(rb.getBlock() != null)
        System.out.println("持っているブロック：" + rb.getBlock());
    ...
    blockstorage[p[0]][p[1]].setRunningBody(rb);
    blockstorage[2][2].setRunningBody(null);
    System.out.println("運搬後");
    System.out.println("自己位置:(" + rb.getX() + "," + rb.getY() + ") 向き:" + rb.getDirection());
    rb.setBlock(null);
    if(rb.getBlock() == null)
        System.out.println("ブロックを持っていない");
    blockstorage[2][2].setBlock(null);
    System.out.println(p[0] + ","  + p[1]);
    blockflag[2] = 1;
    ...
    blockstorage[p[0]][p[1]].setRunningBody(rb);
    blockstorage[m][n].setRunningBody(null);
    System.out.println("運搬後");
    System.out.println("自己位置:(" + rb.getX() + "," + rb.getY() + ") 向き:" + rb.getDirection());
    rb.setBlock(null);
    if(rb.getBlock() == null)
        System.out.println("ブロックを持っていない");
    blockstorage[m][n].setBlock(null);
    System.out.println(p[0] + ","  + p[1]);
    blockflag[A] = 1;
    ...
    while(true)
    {
        ...
        if(rb.getBlock() == null)
            System.out.println("ブロックを持っていない");
        if(p[0] != r[0] || p[1] != r[1])
            blockstorage[r[0]][r[1]].setBlock(null);
    ...
    for(int i = 0; i < 7; i++)
    {
        for(int j = 0; j < 7; j++)
        {
            if(blockstorage[i][j].getBlock() == null || blockstorage[i][j].getBlock().getColor() == -1)
            {
                System.out.print("\t");
            }else{
