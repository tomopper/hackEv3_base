...
class SlalomSectionManager : public SectionManager
{
    ...
    private:
        ...
        wsParam a[100] = {
                        ...
                        {0, Section::TRACER, Section::LENGTH, 3, -0.7, 30, 0.2, 0.1, 1, 1 /*setparam*/, 0, 0, 0, -30, false,Judge::UPDATE, 0, 10, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::TURNANGLE, 8, 0, 6, 0, 0, 1, 1 /*setparam*/, 0, 40, 0, 0, true,Judge::UPDATE, 24, 16.7, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::TURNANGLE, 8, 0, 9, 0, 0, 1, 1 /*setparam*/, 0, -27, 0, 0, true,Judge::UNUPDATE, -37, 33, 0, 0, 0, 0, 0},
                        ...
                        {0, Section::TRACER, Section::TURNANGLE, 5, -0.4, 30, 0.2, 0.1, 1.4, 1 /*setparam*/, 0, 0, 0, -30, false,Judge::UNUPDATE, -85, 20, 0, 0, 0, 0, 0},
        ...
        wsParam b[100] = {
                        ...
                        // {0, Section::VIRTUAL, Section::TURNANGLE, 8, 0, 5, 0, 0, 1.4, 1 /*setparam*/, 0, -14, 0, 0, true,Judge::UPDATE, -13, 16, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::TURNANGLE, 3, 0, 5, 0, 0, 1, 1 /*setparam*/, 0, 19.7, 0, 0, true,Judge::UPDATE, 76.05, 20.288, 0, 0, 0, 0, 0},
