...
class SlalomSectionManager : public SectionManager
{
    ...
    private:
        ...
        wsParam wp[100] = {
                        ...
                        {0, Section::TAIL, Section::TAILANGLE, 0, 600, 0.1, 0.4, 0.04, 0, 0 /*setparam*/, 0, 0, 0, 0, true,Judge::UPDATE, 10, 0, 0, 0, 0, 0, 0}, // 600度目標で回すが、走行に制御を戻さないといけないので10度で終了
                        ...
                        {0, Section::WALKER, Section::LENGTH, 0, 0, 0, 0, 0, 0, 0 /*setparam*/, 0, 0, 5, 0, true,Judge::UPDATE, 0, 6, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::LENGTH, 5, 0, 3, 0, 0, 0, 0 /*setparam*/, 0, 40, 0, 0, true,Judge::UPDATE, 0, 17, 0, 0, 0, 0, 0},
                        // {0, Section::VIRTUAL, Section::LENGTH, 3, 0, 0.2, 0, 0, 0, 0 /*setparam*/, 0, -60, 0, 0, true,Judge::UPDATE, 0, 28.4, 0, 0, 0, 0, 0},
                        // {0, Section::VIRTUAL, Section::LENGTH, 3, 0, 0.225, 0, 0, 0, 0 /*setparam*/, 0, 60, 0, 0, true,Judge::UPDATE, 0, 23.5, 0, 0, 0, 0, 0},
                        // {0, Section::VIRTUAL, Section::LENGTH, 3, 0, 0.25, 0, 0, 0, 0 /*setparam*/, 0, -60, 0, 0, true,Judge::UPDATE, 0, 24, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::LENGTH, 3, 0, 6, 0, 0, 0, 0 /*setparam*/, 0, -37, 0, 0, true,Judge::UPDATE, 0, 33, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::LENGTH, 3, 0, 6, 0, 0, 0, 0 /*setparam*/, 0, 20, 0, 0, true,Judge::UPDATE, 0, 22.5, 0, 0, 0, 0, 0},
