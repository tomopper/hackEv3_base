...
class SlalomSectionManager : public SectionManager
{
    ...
    private:
        ...
        wsParam a[100] = {
                        ...
                        {0, Section::VIRTUAL, Section::TURNANGLE, 5, 0, 30, 0, 0, 1, 1 /*setparam*/, 0, 18.65, 0, 0, true,Judge::UPDATE, 65.7, 22.5, 0, 0, 0, 0, 0},
                        // {0, Section::VIRTUAL, Section::TURNANGLE, 8, 0, 5, 0, 0, 1.4, 1 /*setparam*/, 0, -14, 0, 0, true,Judge::UPDATE, -13, 16, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::TURNANGLE, 5, 0, 5, 0, 0, 1, 1 /*setparam*/, 0, -19.7, 0, 0, true,Judge::UPDATE, -76, 20.3, 0, 0, 0, 0, 0},
                        {0, Section::WALKER, Section::BRIGHTNESS, 0, 0, 0, 0, 0, 0, 0 /*setparam*/, 0, 0, 9, 0.7, true,Judge::UPDATE, 0, 11.27, -0.4, 0, 0, 0, 0},
