...
class SlalomSectionManager : public SectionManager
{
    ...
    private:
        ...
        wsParam a[100] = {
                        ...
                        {0, Section::TRACER, Section::LENGTH, 11, 0, 30, 0.2, 0.8, 1, 1 /*setparam*/, 0, 0, 0, 0, true,Judge::UPDATE, 0, 20, 0, 0, 0, 0, 0},
                        ...
                        {0, Section::VIRTUAL, Section::TURNANGLE, 4, 0, 8, 0, 0, 1, 1 /*setparam*/, 0, 15.45, 0, 0, true,Judge::UNUPDATE, 38.5, 22.5, 0, 0, 0, 0, 0},
                        // {0, Section::VIRTUAL, Section::TURNANGLE, 8, 0, 5, 0, 0, 1.4, 1 /*setparam*/, 0, -14, 0, 0, true,Judge::UPDATE, -13, 16, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::TURNANGLE, 4, 0, 5, 0, 0, 1, 1 /*setparam*/, 0, -16.48, 0, 0, true,Judge::UNUPDATE, -42.5, 20.288, 0, 0, 0, 0, 0},
