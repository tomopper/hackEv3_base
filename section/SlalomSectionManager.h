...
class SlalomSectionManager : public SectionManager
{
    ...
    private:
        ...
        wsParam a[100] = {
                        ...
                        {0, Section::WALKER, Section::LENGTH, 0, 0, 0, 0, 0, 0, 0 /*setparam*/, 0, 0, 12, 0, true,Judge::UPDATE, 0, 22, 0, 0, 0, 0, 0},
                        ...
                        {0, Section::TRACER, Section::LENGTH, 2, -0.5, 8, 0.2, 0.1, 1, 1 /*setparam*/, 0, 0, 0, -30, false,Judge::UPDATE, 0, 10, 0, 0, 0, 0, 0},
                        // {0, Section::WALKER, Section::LENGTH, 0, 0, 0, 0, 0, 0, 0 /*setparam*/, 0, 0, 25, 0, true,Judge::UPDATE, 0, 6, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::LENGTH, 10, 0, 6, 0, 0, 0, 0 /*setparam*/, 0, 40, 0, 0, true,Judge::UPDATE, 0, 17.4, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::TURNANGLE, 8, 0, 9, 0, 0, 0, 0 /*setparam*/, 0, -31, 0, 0, true,Judge::UPDATE, -54, 33, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::TURNANGLE, 8, 0, 10, 0, 0, 0, 0 /*setparam*/, 0, 15.8, 0, 0, true,Judge::UPDATE, 15, 8.5, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::TURNANGLE, 3, 0, 8, 0, 0, 0, 0 /*setparam*/, 0, 15.8, 0, 0, true,Judge::UNUPDATE, 70, 22.5, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::TURNANGLE, 8, 0, 5, 0, 0, 0, 0 /*setparam*/, 0, -15, 0, 0, true,Judge::UPDATE, -13, 16, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::TURNANGLE, 3, 0, 5, 0, 0, 0, 0 /*setparam*/, 0, -15, 0, 0, true,Judge::UNUPDATE, -60, 20.3, 0, 0, 0, 0, 0},
        ...
        wsParam b[100] = {
                        ...
                        {0, Section::VIRTUAL, Section::LENGTH, 8, 0, 9, 0, 0, 0, 0 /*setparam*/, 0, 36, 0, 0, true,Judge::UPDATE, 0, 30.5, 0, 0, 0, 0, 0},
