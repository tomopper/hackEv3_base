...
class SlalomSectionManager : public SectionManager
{
    ...
    private:
        ...
        wsParam a[100] = {
                        ...
                        {0, Section::VIRTUAL, Section::LENGTH, 10, 0, 3, 0, 0, 0, 0 /*setparam*/, 0, 40, 0, 0, true,Judge::UPDATE, 0, 17.4, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::LENGTH, 8, 0, 9, 0, 0, 0, 0 /*setparam*/, 0, -36, 0, 0, true,Judge::UPDATE, 0, 31.6, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::LENGTH, 8, 0, 10, 0, 0, 0, 0 /*setparam*/, 0, 15.8, 0, 0, true,Judge::UPDATE, 0, 8.5, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::LENGTH, 3, 0, 8, 0, 0, 0, 0 /*setparam*/, 0, 15.8, 0, 0, true,Judge::UNUPDATE, 0, 22.5, 0, 0, 0, 0, 0},
