...
private:
  ...
  wParam a[100] = {{0, Section::VIRTUAL2, Section::LENGTH, 40, 0, 0.01, 0, 0, 1, 1 /*setparam*/, 0, 0, 30, 0, true, Judge::UPDATE, 0, 57.7, 0, 0, 0, 0, 0},
                   ...
                   {0, Section::VIRTUAL2, Section::LENGTH, -40, 0, 0.2, 0.02, 0.01, 1, 1 /*setparam*/, 180, 0, 30, 0, false, Judge::UPDATE, 0, -25, 0, 0, 0, 0, 0},
                   ...
                   {0, Section::TRACER, Section::LENGTH, 42, 0, 15, 0.2, 0.1, 1, 1 /*setparam*/, 0, 0, 0, 30, false, Judge::UNUPDATE, 0, 87, 0, 0, 0, 0, 0},
