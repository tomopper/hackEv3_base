...
private:
  ...
  wParam wp1[100] = {{0, Section::TRACER, Section::LENGTH, 25, 0, 15, 0, 0, 1, 1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 5, 0, 0, 0, 0,0,false},
                      ...
                      {0, Section::TRACER, Section::LENGTH, 30, 0, 20, 0.01, 0.035, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 10, 0, 0, 0, 0,0,false},
                      {0, Section::TRACER, Section::LENGTH, 40, 0, 10, 0.01, 0.025, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0,40, 0, 0, 0, 0,0,false},
                      {0, Section::TRACER, Section::LENGTH, 30, 0, 5, 0.01, 0.01, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0,45, 0, 0, 0, 0,0,false},
