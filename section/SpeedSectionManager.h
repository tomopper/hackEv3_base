...
private:
    ...
    wParam wp[100] = {{0, Section::TRACER, Section::LENGTH, 100, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 90, 50, 0, 0, 0, 0},
                      {0, Section::TRACER, Section::LENGTH, 10, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, -30, false, Judge::UPDATE, 90, 30, 0, 0, 0, 0},
