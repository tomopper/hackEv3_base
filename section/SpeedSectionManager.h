...
private:
  ...
  wParam a[100] = {{0, Section::VIRTUAL2, Section::LENGTH, 40, 0, 0.01, 0, 0, 0, 0 /*setparam*/, 0, 0, 30, 0, true, Judge::UPDATE, 0, 57.7, 0, 0, 0, 0, 0},
                   {0, Section::VIRTUAL, Section::LENGTH, 30, 0, 6, 0.2, 0.1, 0, 0 /*setparam*/, 0, 63, 0, 30, false, Judge::UPDATE, 0, 106.5, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 15, 0, 30, 0.3, 0.2, 0, 0 /*setparam*/, 0, 0, 0, 30, true, Judge::UPDATE, 0, 8, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 25, 0, 20, 0.3, 0.2, 0, 0 /*setparam*/, 0, 0, 0, 30, true, Judge::UNUPDATE, 0, 15, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 35, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, true, Judge::UPDATE, 0, 25, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 25, 0, 30, 0.2, 0.2, 0, 0 /*setparam*/, 0, 0, 0, 30, true, Judge::UNUPDATE, 0, 100, 0, 0, 0, 0, 0},
                   ...
                   {0, Section::TRACER, Section::LENGTH, 20, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UNUPDATE, 0, 90, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 40, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UNUPDATE, 0, 220, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::TURNANGLE, 25, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, -90, 0, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 35, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 87, 0, 0, 0, 0, 0},
