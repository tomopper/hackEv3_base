...
wParam b[100] = { 
    ...
    wParam wp1[100] = {
                      ...
                      {0, Section::TRACER, Section::LENGTH, 25, 0, 15, 0, 0, 1, 1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 5, 0, 0, 0, 0,0,false},
                      ...
                      {0, Section::TRACER, Section::LENGTH, 40, 0, 20, 0, 0.2, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 50, 0, 0, 0, 0,0,false},
                      {0, Section::TRACER, Section::LENGTH, 30, 0, 30, 0.2, 0.1, 0.8,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 90, 0, 0, 0, 0,0,false},
                       {0, Section::TRACER, Section::LENGTH, 35, 0, 20, 0.1, 0.4, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 50, 0, 0, 0, 0,0,false},
                      {0, Section::TRACER, Section::LENGTH, 40, 0, 20, 0.2, 0.5, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 50, 0, 0, 0, 0,0,false},
                      {0, Section::TRACER, Section::LENGTH, 30, 0, 30, 0.2, 0.1, 1.3,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 10, 0, 0, 0, 0,0,false},
                         {0, Section::TRACER, Section::LENGTH, 30, 0, 30, 0.2, 0.1, 1.1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 10, 0, 0, 0, 0,0,false},
                      {0, Section::TRACER, Section::LENGTH, 40, 0, 20, 0.2, 0.2, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0,50, 0, 0, 0, 0,0,false},
                      {0, Section::TRACER, Section::LENGTH, 30, 0, 30, 0.2, 0.1, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0,140, 0, 0, 0, 0,0,false},
