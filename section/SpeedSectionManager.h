...
private:
  ...
  wParam a[100] = {{0, Section::VIRTUAL2, Section::LENGTH, 35, 0, 0.01, 0, 0, 0, 0 /*setparam*/, 0, 0, 30, 0, true, Judge::UPDATE, 0, 57.7, 0, 0, 0, 0, 0},
                   {0, Section::VIRTUAL, Section::LENGTH, 25, 0, 6, 0.2, 0.1, 0, 0 /*setparam*/, 0, 63, 0, 30, false, Judge::UPDATE, 0, 106, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 25, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, true, Judge::UPDATE, 0, 5, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 30, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, true, Judge::UPDATE, 0, 40, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 25, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, true, Judge::UNUPDATE, 0, 105, 0, 0, 0, 0, 0},
                   {0, Section::VIRTUAL2, Section::LENGTH, 20, 0, 0.1, 0, 0, 0, 0 /*setparam*/, 0, 0, 30, 0, false, Judge::UPDATE, 0, 2, 0, 0, 0, 0, 0},
                   {0, Section::VIRTUAL2, Section::LENGTH, 10, 0, 0.1, 0, 0, 0, 0 /*setparam*/, 0, 0, 30, 0, false, Judge::UNUPDATE, 0, 4, 0, 0, 0, 0, 0},
                   ...
                   {0, Section::VIRTUAL2, Section::LENGTH, -35, 0, 0.1, 0.02, 0.1, 0, 0 /*setparam*/, 180, 0, 30, 0, false, Judge::UNUPDATE, 0, -122, 0, 0, 0, 0, 0},
                   ...
                   {0, Section::VIRTUAL2, Section::LENGTH, -20, 0, 0.2, 0.02, 0.01, 0, 0 /*setparam*/, 180, 0, 30, 0, false, Judge::UNUPDATE, 0, -20, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 10, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 3, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 20, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UNUPDATE, 0, 100, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 40, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 120, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::TURNANGLE, 25, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, -90, 0, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 35, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 85, 0, 0, 0, 0, 0},
  ...
  wParam b[100] = {{0, Section::WALKER, Section::LENGTH, 20, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false,Judge::UPDATE, -90, 60, 0, 0, 58, 5,10,false},
