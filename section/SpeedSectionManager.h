...
private:
  ...
  wParam a[100] = {{0, Section::VIRTUAL2, Section::LENGTH, 40, 0, 0.01, 0, 0, 1, 1 /*setparam*/, 0, 0, 30, 0, true, Judge::UPDATE, 0, 57.7, 0, 0, 0, 0, 0},
                   ...
                   {0, Section::VIRTUAL, Section::TURNANGLE, 40, 0, 6, 0.2, 0.1, 1, 1 /*setparam*/, 0, 37, 0, 30, false, Judge::UPDATE, 86, 0, 0, 0, 0, 0, 0},
                   ...
                   {0, Section::VIRTUAL, Section::TURNANGLE, -40, 0, 6, 0, 0, 1, 1 /*setparam*/, 0, 34, 0, 0, false, Judge::UPDATE, -88, 0, 0, 0, 0, 0, 0},
                   ...
                   {0, Section::VIRTUAL2, Section::LENGTH, 40, 0, 0.2, 0.02, 0.01, 1, 1 /*setparam*/, 0, 0, 30, 0, false, Judge::UPDATE, 0, 138, 0, 0, 0, 0, 0},
                   {0, Section::VIRTUAL, Section::TURNANGLE, 40, 0, 6, 0, 0, 1, 1 /*setparam*/, 0, -38, 0, 0, false, Judge::UPDATE, -86, 0, 0, 0, 0, 0, 0},
                   {0, Section::VIRTUAL2, Section::LENGTH, 40, 0, 0.2, 0.02, 0.01, 1, 1 /*setparam*/, 0, 0, 30, 0, false, Judge::UPDATE, 0, 79, 0, 0, 0, 0, 0},
                   //{0, Section::VIRTUAL2, Section::COLOR, 40, 0, 0.2, 0.02, 0.01, 1, 1 /*setparam*/, 0, 0, 30, 0, false, Judge::UPDATE, 0, 0, 0, 0, 0, 0.01, 0},
...
wParam wp1[100] = {{0, Section::TRACER, Section::LENGTH, 25, 0, 30, 0.2, 0.1, 1, 1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 5, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 42, 0, 20, 0.2, 0.1, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 65, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 40, 0, 30, 0.2, 0.1, 0.7,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 100, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 42, 0, 20, 0.2, 0.1, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 50, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 40, 0, 30, 0.2, 0.1, 1.7,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 95, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 42, 0, 20, 0, 0.1, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 75, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 40, 0, 30, 0.2, 0.1, 1.7,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 10, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 40, 0, 30, 0.2, 0.1, 1.7,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 10, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 42, 0, 20, 0, 0.1, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 90, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 40, 0, 30, 0.2, 0.1, 0.7,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 20, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 38, 0, 20, 0, 0.1, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 40, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 40, 0, 30, 0.2, 0.1, 0.7,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 40, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 40, 0, 20, 0.2, 0.1, 0.9,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 10, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 42, 0, 20, 0, 0, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 70, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 40, 0, 30, 0.2, 0.1, 0.7,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 40, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 35, 0, 20, 0, 0, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 40, 0, 0, 0, 0,0,false},
                   {0, Section::TRACER, Section::LENGTH, 40, 0, 20, 0, 0, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 140, 0, 0, 0, 0,0,false},
                   ...
                   {0, Section::TRACER, Section::COLOR, 40, 0, 0.2, 0.02, 0.01, 1, 1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 0, 0, 0, 0, 0.01, 0},
  ...
  void setJudge(Section *sc);
    ...
    //Virtual->setParam(20,2,0.2,0,1,1)
    //Walker->setCommand(0,10)
    wParam wp[100] = {{0, Section::TRACER, Section::LENGTH, 10, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 5, 0, 0, 0, 0},
                      {0, Section::TRACER, Section::LENGTH, 32, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 65, 0, 0, 0, 0},
                      {0, Section::TRACER, Section::LENGTH, 30, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 100, 0, 0, 0, 0},
                      {0, Section::TRACER, Section::LENGTH, 35, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 50, 0, 0, 0, 0},
                      {0, Section::TRACER, Section::LENGTH, 30, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 100, 0, 0, 0, 0},
                      {0, Section::TRACER, Section::LENGTH, 35, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 70, 0, 0, 0, 0},
                      {0, Section::TRACER, Section::LENGTH, 30, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 40, 0, 0, 0, 0},
                      {0, Section::TRACER, Section::LENGTH, 35, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 70, 0, 0, 0, 0},
                      {0, Section::TRACER, Section::LENGTH, 30, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 30, 0, 0, 0, 0},
                      {0, Section::TRACER, Section::LENGTH, 35, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 40, 0, 0, 0, 0},
                      {0, Section::TRACER, Section::LENGTH, 30, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 60, 0, 0, 0, 0},
                      {0, Section::TRACER, Section::LENGTH, 35, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 60, 0, 0, 0, 0},
