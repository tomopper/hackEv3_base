...
private:
  ...
  wParam a2[100] = {{0, Section::VIRTUAL2, Section::LENGTH, 10, 0, 18.0, 0, 0, 0, 0 /*setparam*/, 0/*absangle*/, 0, 0, 0/*単純走法の曲がり具合*/, false, Judge::UPDATE, 0, 1000000, 0, 0, 0, 0, 0},
                    {-1, Section::VIRTUAL2, Section::LENGTH, 0, 0, 18.0, 0, 0, 0, 0 /*setparam*/, 0/*absangle*/, 0, 0, 0/*単純走法の曲がり具合*/, false, Judge::UPDATE, 0, 1000000, 0, 0, 0, 0, 0},
                    {-1, Section::VIRTUAL2, Section::LENGTH, 0, 0, 18.0, 0, 0, 0, 0 /*setparam*/, 0/*absangle*/, 0, 0, 0/*単純走法の曲がり具合*/, false, Judge::UPDATE, 0, 1000000, 0, 0, 0, 0, 0},
                    {-1, Section::WALKER, Section::LENGTH, 0, 0, 18.0, 19.5, 18.0, 0, 0 /*setparam*/, 0/*absangle*/, 0, 0, 0/*単純走法の曲がり具合*/, false, Judge::UPDATE, 0, 1000000, 0, 0, 0, 0, 0},
