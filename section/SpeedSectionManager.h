...
wParam b[100] = { 
    ...
    wParam wp1[100] = {
                      ...
                      {0, Section::TRACER, Section::LENGTH, 40, 0, 30, 0.2, 0.1, 1.5,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 10, 0, 0, 0, 0,0,false},
                       {0, Section::TRACER, Section::LENGTH, 40, 0, 20, 0.2, 0.1, 1.2,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 10, 0, 0, 0, 0,0,false},
