...
private:
  ...
  wParam a[100] = {{0, Section::VIRTUAL2, Section::LENGTH, 40, 0, 0.01, 0, 0, 0, 0 /*setparam*/, 0, 0, 30, 0, true, Judge::UPDATE, 0, 57.7, 0, 0, 0, 0, 0},
                   ...
                   {0, Section::TRACER, Section::LENGTH, 15, 0, 30, 0.3, 0.2, 0, 0 /*setparam*/, 0, 0, 0, 30, true, Judge::UPDATE, 0, 10, 0, 0, 0, 0, 0},
                   ...
                   {0, Section::TRACER, Section::LENGTH, 25, 0, 30, 0.2, 0.1, 0, 0 /*setparam*/, 0, 0, 0, 30, true, Judge::UNUPDATE, 0, 90, 0, 0, 0, 0, 0},
