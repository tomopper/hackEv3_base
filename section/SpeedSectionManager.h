...
wParam b[100] = { 
    ...
    wParam wp1[100] = {
                      ...
                      {0, Section::TRACER, Section::LENGTH, 38, 0, 30, 0.2, 0.1, 1.3,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 20, 0, 0, 0, 0,0,false},
                      {0, Section::TRACER, Section::LENGTH, 42, 0, 30, 0, 0.1, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 90, 0, 0, 0, 0,0,false},
                      {0, Section::TRACER, Section::LENGTH, 40, 0, 30, 0.2, 0.1, 0.7,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 20, 0, 0, 0, 0,0,false},
                      {0, Section::TRACER, Section::LENGTH, 38, 0, 30, 0, 0.1, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 40, 0, 0, 0, 0,0,false},
                      ...
                      {0, Section::TRACER, Section::LENGTH, 30, 0, 30, 0.2, 0.1, 1,1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 65, 0, 0, 0, 0,0,false},
