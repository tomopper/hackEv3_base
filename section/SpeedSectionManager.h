...
private:
  ...
  wParam a[100] = {{0, Section::VIRTUAL2, Section::LENGTH, 40, 0, 0.01, 0, 0, 1, 1 /*setparam*/, 0, 0, 30, 0, true, Judge::UPDATE, 0, 57.7, 0, 0, 0, 0, 0},
                   ...
                   {0, Section::TRACER, Section::LENGTH, 30, 0, 30, 0.2, 0.1, 1, 1 /*setparam*/, 0, 0, 0, 30, true, Judge::UPDATE, 0, 25, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 25, 0, 30, 0.2, 0.1, 0.8, 1 /*setparam*/, 0, 0, 0, 30, true, Judge::UNUPDATE, 0, 90, 0, 0, 0, 0, 0},
                   ...
                   {0, Section::VIRTUAL, Section::TURNANGLE, -20, 0, 8, 0, 0, 0, 0 /*setparam*/, 0, 37, 0, 0, false, Judge::UPDATE, -88, 0, 0, 0, 0, 0, 0},
                   ...
                   {0, Section::TRACER, Section::LENGTH, 25, 0, 30, 0.2, 0.1, 1, 1 /*setparam*/, 0, 0, 0, 30, false, Judge::UNUPDATE, 0, 90, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 43, 0, 30, 0.2, 0.1, 1, 1 /*setparam*/, 0, 0, 0, 30, false, Judge::UNUPDATE, 0, 220, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::TURNANGLE, 30, 0, 30, 0.2, 0.1, 1.2, 1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, -87, 0, 0, 0, 0, 0, 0},
                   {0, Section::TRACER, Section::LENGTH, 35, 0, 15, 0.2, 0.1, 1, 1 /*setparam*/, 0, 0, 0, 30, false, Judge::UPDATE, 0, 89, 0, 0, 0, 0, 0},
