    ...
    private :
        ...
        waParam b[100] = {
         ...
         waParam a1[100] = {
                        ...
                        {0, Section::VIRTUAL, Section::BRIGHTNESS, 20, 0, 30, 0, 0, 1.2, 1 /*setparam*/, 0, -32, 0, 0, true,Judge::UPDATE, -50, 0, -0.7, 0, 0, 0, 0},
                        {0, Section::TRACER, Section::LENGTH, 4, 0, 30, 0, 0.1, 1, 1 /*setparam*/, 0, 0, 0, 30, false,Judge::UPDATE, -80, 12.7, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::TURNANGLE, 10, 0, 30, 0, 0, 0.8, 1 /*setparam*/, 0, 14.5, 0, 0, true,Judge::UPDATE, 87, 0, -0.3, 0, 0, 0, 0},
                        // {0, Section::VIRTUAL, Section::BRIGHTNESS, 20, 0, 30, 0, 0, 0.8, 1 /*setparam*/, 0, 40, 0, 0, true,Judge::UPDATE, 85, 0, -0.4, 0, 0, 0, 0},
