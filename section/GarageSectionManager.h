...
class GarageSectionManager : public SectionManager
{
    ...
    private :
        ...
        waParam b[100] = {
         ...
         waParam a1[100] = {
                        {0, Section::TRACER, Section::TURNANGLE, 30, 0, 30, 0.2, 0.135, 1, 1 /*setparam*/, 0, 0, 0, 30, false,Judge::UNUPDATE, 0, 25, 0, 0, 0, 0, 0},
         ...
         waParam b1[100] = {
                        {0, Section::TRACER, Section::TURNANGLE, 30, 0, 30, 0.2, 0.135, 1, 1 /*setparam*/, 0, 0, 0, 30, true,Judge::UNUPDATE, 0, 25, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::TURNANGLE, 20, 0, 30, 0, 0, 1.2, 1 /*setparam*/, 0, 32, 0, 0, true,Judge::UNUPDATE, -85, 0, -0.4, 0, 0, 0, 0},
