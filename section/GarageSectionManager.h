    ...
    private :
        ...
        waParam b[100] = {
         ...
         waParam a1[100] = {
                        ...
                        {0, Section::VIRTUAL, Section::TURNANGLE, 20, 0, 30, 0, 0, 1.2, 1 /*setparam*/, 0, -29, 0, 0, true,Judge::UNUPDATE, -85, 0, -0.4, 0, 0, 0, 0},
                        {0, Section::TRACER, Section::COLOR, 6, 0, 30, 0, 0.1, 1, 1 /*setparam*/, 0, 0, 0, 30, true,Judge::UNUPDATE, -85, 12.7, 0, 0, 141, 0.9, 0},
                        {0, Section::VIRTUAL, Section::TURNANGLE, 7, 0, 30, 0, 0, 0.8, 1 /*setparam*/, 0, 10.5, 0, 0, true,Judge::UNUPDATE, 7, 0, -0.3, 0, 0, 0, 0},
                        // {0, Section::VIRTUAL, Section::BRIGHTNESS, 20, 0, 30, 0, 0, 0.8, 1 /*setparam*/, 0, 40, 0, 0, true,Judge::UPDATE, 85, 0, -0.4, 0, 0, 0, 0},
