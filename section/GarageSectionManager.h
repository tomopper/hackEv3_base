...
class GarageSectionManager : public SectionManager
{
    ...
    private :
        ...
        waParam a[100] = {
                        ...
                        {0, Section::TRACER, Section::LENGTH, 10, -0.3, 30, 0, 0.1, 1, 1 /*setparam*/, 0, 0, 0, -30, true,Judge::UNUPDATE, 0, 100, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL2, Section::LENGTH, 30, 0, 0.01, 0, 0, 1, 1 /*setparam*/, 0, 0, 0, 0, true,Judge::UNUPDATE, 0, 195, 0, 0, 0, 0, 0},
