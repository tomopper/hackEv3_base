...
class GarageSectionManager : public SectionManager
{
    ...
    private :
        ...
        waParam a[100] = {
                        ...
                        {0, Section::WALKER, Section::TURNANGLE, 0, 0, 0, 0, 0, 0, 0 /*setparam*/, 0, 0, 0, 10, true,Judge::UPDATE, -90, 0, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL2, Section::LENGTH, 40, 0, 0.01, 0, 0, 1, 1 /*setparam*/, 0, 0, 0, 0, true,Judge::UPDATE, 0, 70, 0, 0, 0, 0, 0},
                        {0, Section::TRACER, Section::LENGTH, 5, -0.3, 30, 0, 0.1, 1, 1 /*setparam*/, 0, 0, 0, -30, true,Judge::UNUPDATE, 0, 95, 0, 0, 0, 0, 0},
