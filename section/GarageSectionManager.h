...
class GarageSectionManager : public SectionManager
{
    ...
    private :
        ...
        waParam a[100] = {
                        ...
                        {0, Section::TRACER, Section::LENGTH, 5, 0, 25, 0.2, 0.1, 1, 1 /*setparam*/, 0, 0, 0, 30, false,Judge::UNUPDATE, 0, 90, 0, 0, 0, 0, 0},
                        ...
                        {0, Section::WALKER, Section::LENGTH, 0, 0, 0, 0, 0, 0, 0 /*setparam*/, 0, 0, -60, 0, true,Judge::UPDATE, 0, -95, 0, 0, 0, 0, 0},
                        {0, Section::VIRTUAL, Section::TURNANGLE, -30, 0, 6, 0, 0, 0, 0 /*setparam*/, 0, 30, 0, 0, true,Judge::UPDATE, -90, 0, 0, 0, 0, 0, 0},
                        {0, Section::WALKER, Section::BRIGHTNESS, 0, 0, 0, 0, 0, 0, 0 /*setparam*/, 0, 0, -30, 0, true,Judge::UPDATE, 0, 0, -0.8, 0, 0, 0, 0},
